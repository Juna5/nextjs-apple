...
function Button({ title, onClick, width, loading, padding, noIcon }: Props) {
    return (
        ...
        >
            ...
            <span className="absolute top-0 left-0 -mt-8 -ml-5 h-20 w-8 translate-x-1 rotate-45 transform bg-white opacity-10 transition-all duration-300 ease-out group-hover:translate-x-0"></span>
