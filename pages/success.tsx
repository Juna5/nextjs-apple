    ...
    return (
        <div>
            ...
            <main className="grid grid-cols-1 lg:grid-cols-9">
                <section className="order-2 mx-auto max-w-xl pb-12 lg:mx-0 lg:col-span-5 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
                    <Link
                        href="/"
                        className="relative ml-14 h-24 w-12 cursor-pointer hidden transition lg:inline-flex"
                    >
                        <div>
                            <Image
                                src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg"
